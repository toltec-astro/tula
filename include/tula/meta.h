...
template <typename... Ts> auto fwd_capture_impl(Ts &&...xs) noexcept {
...
constexpr auto apply_sequence(Func &&f, S<T, Is...>) -> decltype(auto) {
...
#define TULA_FWD_CAPTURE(...) TULA_GET_MACRO_NARG_OVERLOAD(TULA_FWD_CAPTURE, __VA_ARGS__)
