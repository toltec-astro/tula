...
#define TULA_DETAILS_NARG2(...)                                             TULA_DETAILS_BUGFX(TULA_DETAILS_NARG1(__TULA_DETAILS_ARGS__, TULA_DETAILS_RSEQN()))
#define TULA_DETAILS_NARG1(...)                                             TULA_DETAILS_BUGFX(TULA_DETAILS_ARGSN(__TULA_DETAILS_ARGS__))
...
#define GET_MACRO_NARG_OVERLOAD(func, ...) \
    TULA_DETAILS_FUNC1(func, TULA_DETAILS_BUGFX(TULA_DETAILS_NARG2(__TULA_DETAILS_ARGS__)))(__TULA_DETAILS_ARGS__)
